...
- [ ] 2. 实现基础数据结构和协议定义
  ...
  - [ ] 2.3 实现 Directory 状态结构
    - 定义 directory_entry_t 和相关状态枚举
    - 实现状态转换函数
    - _需求: 7.1, 7.2, 4.4_

  - [ ] 2.4 为 Directory 状态编写属性测试
